...
import { FaReact, FaNodeJs, FaPhp, FaHtml5, FaCss3Alt, FaJs, FaGithub, FaDatabase, FaInstagram, FaLinkedin} from 'react-icons/fa'; 
      ...
      <div className="container mx-auto py-10 px-4">
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">            
          ...
          <div className="space-y-4">
            <h1 className="text-3xl md:text-5xl text-center font-bold text-green-400">
              <ReactTyped
            ...
            <p className="text-lg md:text-xl text-center">
              <ReactTyped
                strings={[
                  "victor_heringer@outlook.com - (27)99972-6799",
                ]}
                typeSpeed={40}
                backSpeed={20}
                showCursor={false}
          ...
          <div className="flex mt-10 justify-center items-center">
            <img 
              ...
              className="w-36 h-36 md:w-48 md:h-48 lg:w-60 lg:h-60 rounded-full border-4 border-green-400 shadow-lg"
            />
          </div>

          {/* Seção de ícones das linguagens */}
          <div className="mt-10">
            <p className="text-lg md:text-xl font-bold text-green-400 text-center">// Tecnologias que utilizo:</p>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mt-6 justify-items-center text-center">
              <div>
                <FaReact className="text-blue-400 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">React</p>
              </div>
              <div>
                <FaNodeJs className="text-green-500 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">Node.js</p>
              </div>
              <div>
                <FaPhp className="text-indigo-600 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">PHP</p>
              </div>
              <div>
                <FaHtml5 className="text-orange-500 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">HTML5</p>
              </div>
              <div>
                <FaCss3Alt className="text-blue-600 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">CSS3</p>
              </div>
              <div>
                <FaJs className="text-yellow-400 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">JavaScript</p>
              </div>
              <div>
                <FaGithub className="text-white text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">GitHub</p>
              </div>
              <div>
                <FaDatabase className="text-gray-500 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">SQL Server</p>
              </div>
              <div>
                <SiMongodb className="text-green-500 text-5xl md:text-6xl mx-auto" />
                <p className="mt-2 text-white">MongoDB</p>
              </div>
              <div>
                <SiPython className="text-yellow-400 text-5xl md:text-6xl mx-auto" />
          ...
          <div className="mt-8 bg-gray-700 p-4 rounded-md">
            <p className="text-lg md:text-xl font-bold text-green-400">// Sobre Mim:</p>
          ...
          <div className="mt-10 bg-gray-700 p-6 rounded-md">
            <p className="text-lg md:text-xl font-bold text-green-400">// Experiências Profissionais:</p>
          ...
          {/* Formações */}
          <div className="mt-10 bg-gray-700 p-6 rounded-md">
            <p className="text-lg md:text-xl font-bold text-green-400">// Formações:</p>
          ...
          {/* Produtos no Mercado */}
          <div className="mt-10 bg-gray-700 p-6 rounded-md">
            <p className="text-lg md:text-xl font-bold text-green-400">// Produtos no Mercado:</p>
          ...
          {/* Redes Sociais */}
          <div className="mt-10 bg-gray-700 p-6 rounded-md">
            <p className="text-lg md:text-xl font-bold text-green-400 text-center">// Redes Sociais:</p>
